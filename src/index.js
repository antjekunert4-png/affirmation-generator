...
function generateAffirmation(event) {
  ...
  let context =
    "You are an affirmation expert. Your mission is to write a 2 line affirmation and separate the lines with a <br />. Make sure to follow the user instructions below. Sign the affirmation with 'SheCodes AI' in a <strong> element";
